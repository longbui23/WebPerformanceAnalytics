...
/*
1.	Gsearch seems to be the biggest driver of our business. We could pull monthly 
...
/*
3.	While we’re on Gsearch, we could dive into nonbrand, and pull monthly sessions and orders split by device type. 
*/ 
...
/*
4. One of our more pessimistic board members may be concerned about the large % of traffic from Gsearch. 
We could pull monthly trends for Gsearch, alongside monthly trends for each of our other channels.
*/ 
...
/*
5.	We ciykd analyze our website performance improvements over the course of the first 8 months,
especially, session to order conversion rates by month. 
...
/*
6.	For the gsearch lander test, we could estimate the revenue that test earned us 
(Analyzing increase in CVR from the test (Jun 19 – Jul 28), and use 
...
--The landing page to each session, restricting to home or lander-1
...
-- Most reent pageview for gsearch nonbrand where the traffic was sent to /home
SELECT 
...
/*
7.	For the landing page test  it would be great to show a full conversion funnel 
from each of the two pages to orders. We can use the same time period we analyzed last time (Jun 19 – Jul 28).
*/ 
...
/*
8.	We want quantify the impact of our billing test, as well. We could the lift generated 
