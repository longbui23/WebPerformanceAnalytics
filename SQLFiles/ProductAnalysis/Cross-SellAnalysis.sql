...
/*
1. We would like to inspect our volume growth. Let's pull overall session and order volume, 
...
/*
2. Next, let’s showcase all of our efficiency improvements. We could investigate on quarterly figures 
...
/*
3. We’d like to show how we’ve grown specific channel: a quarterly view of orders 
...
/*
4. The overall session-to-order conversion rate trends for those same channels, 
by quarter.
*/
...
/*
6. Let’s dive deeper into the impact of introducing new products. We will pull monthly sessions to 
...
-- The views of the /products page
